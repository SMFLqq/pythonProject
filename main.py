...
class Bike:
    def __init__(self, bike_list):
        self.bike=random.choice(list(bike_list))
        self.salary=bike_list[self.bike]["salary"]
        self.gladness_less=bike_list[self.bike]["gladness_less"]
